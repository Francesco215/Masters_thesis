In section \ref{sec:beconcini} we obtained the frequency response of the non-local resistance (equation \ref{eq:fre-response-beconcini})
\begin{equation}
